...
<Project Type="Project" LVVersion="19008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Actor-Module" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Actor Private Data.ctl" Type="VI" URL="../Actor/Actor Private Data.ctl"/>
			<Item Name="Actor Private Events -- cluster.ctl" Type="VI" URL="../Actor/Actor Private Events -- cluster.ctl"/>
			<Item Name="Payload -- cluster.ctl" Type="VI" URL="../Actor/Payload -- cluster.ctl"/>
			<Item Name="Request -- cluster.ctl" Type="VI" URL="../Actor/Request -- cluster.ctl"/>
			<Item Name="Response -- cluster.ctl" Type="VI" URL="../Actor/Response -- cluster.ctl"/>
			<Item Name="Create Actor.vi" Type="VI" URL="../Actor/Create Actor.vi"/>
			<Item Name="Register to IncomingMessages.vi" Type="VI" URL="../Actor/Register to IncomingMessages.vi"/>
			<Item Name="Actor Process.vi" Type="VI" URL="../Actor/Actor Process.vi"/>
			<Item Name="Send Publish Signal Message.vi" Type="VI" URL="../Actor/Send Publish Signal Message.vi"/>
			<Item Name="Send Request Message.vi" Type="VI" URL="../Actor/Send Request Message.vi"/>
			<Item Name="Send Response Message.vi" Type="VI" URL="../Actor/Send Response Message.vi"/>
			<Item Name="Send unSubscribe Message.vi" Type="VI" URL="../Actor/Send unSubscribe Message.vi"/>
			<Item Name="Send Subscribe Message.vi" Type="VI" URL="../Actor/Send Subscribe Message.vi"/>
			<Item Name="Send Stop Message.vi" Type="VI" URL="../Actor/Send Stop Message.vi"/>
		</Item>
		...
		<Item Name="03 -- Request Reply" Type="Folder">
			<Item Name="03. Native MQTT Service Provider.vi" Type="VI" URL="../03. Native MQTT Service Provider.vi"/>
			<Item Name="03. Native MQTT Service Client.vi" Type="VI" URL="../03. Native MQTT Service Client.vi"/>
		</Item>
		<Item Name="04 -- Streaming" Type="Folder">
			<Item Name="04. Native MQTT Streaming Source.vi" Type="VI" URL="../04. Native MQTT Streaming Source.vi"/>
			<Item Name="04. Native MQTT Streaming Client.vi" Type="VI" URL="../04. Native MQTT Streaming Client.vi"/>
			<Item Name="04. Streaming Simulator.vi" Type="VI" URL="../04. Streaming Simulator.vi"/>
			<Item Name="04. Downloader.vi" Type="VI" URL="../04. Downloader.vi"/>
			<Item Name="streaming-request -- cluster.ctl" Type="VI" URL="../streaming-request -- cluster.ctl"/>
		</Item>
		<Item Name="05 -- Routing-Delegation" Type="Folder">
			<Item Name="05. Native MQTT Service Provider.vi" Type="VI" URL="../05. Native MQTT Service Provider.vi"/>
